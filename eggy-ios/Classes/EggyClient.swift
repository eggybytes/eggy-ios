...
public class EggyClient {
    ...
    public static func registerWithDeviceApi(deviceToken: String) {
    ...
    public static func sendPushEvent(eventType: String, userInfo: [AnyHashable: Any]) {
        guard EggyClient.shared() != nil else { return }
        let client = EggyClient.shared()!

        var request = URLRequest(url: client.config.eventsUrl)
        request.setValue(client.config.apiToken, forHTTPHeaderField: Constants.authorizationHeader)
        ...
        let body: [String: Any] = [
            "raw_events": [[
                ...
                "client_id": client.device.clientUserId as Any,
                ...
                "eventMetadata": [
                    eventType: [
                        ...
                        "device_token": client.pushToken as Any
                    ]
                ]
            ]]
        ]
