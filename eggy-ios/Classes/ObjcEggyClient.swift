...
public final class ObjcEggyClient: NSObject {
    ...
    @available(iOS 10.0, *)
    @objc public static func userNotificationCenter(_ center: UNUserNotificationCenter, willPresent notification: UNNotification, withCompletionHandler completionHandler: @escaping (UNNotificationPresentationOptions) -> Void) {
        return EggyClient.userNotificationCenter(center, willPresent: response, notification: completionHandler)
    }
